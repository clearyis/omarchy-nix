...
}:
{
  wayland.windowManager.hyprland.settings = {
    windowrule = [
      ...
      "opacity 1 1, class:^(chromium|google-chrome|google-chrome-unstable)$"
      "opacity 1 1, initialClass:^(chrome-.*-Default)$ # web apps"
      ...
      "opacity 1 1, class:chromium-browser"
      "opacity 1 1, class:brave-browser"
